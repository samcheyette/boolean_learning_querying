...
if __name__ == "__main__":
    ...
    for g in enum:
        ...
        n_subnodes = g.count_subnodes()
        if concept not in concepts:
            concepts[concept] = n_subnodes
            concepts[invert(concept)] = n_subnodes
        ...
        if n_subnodes < concepts[concept]:
            concepts[concept] = n_subnodes
            concepts[invert(concept)] = n_subnodes
            print
            for c in sorted(concepts.keys(), key=lambda x: concepts[x]):
